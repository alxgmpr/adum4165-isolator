...
XU3_IN, XU3_OUT = 102.000, 109.300
...
dp_fcu_b = [(XC1, W_UP), (XN1, Y_UP), (XFAN, Y_UP), (XU3_IN, 24.050), (XU3_OUT, 24.050),
            (109.500, 24.250), (110.825, 24.250),           # into J2.B6
...
dm_fcu_b = [(XC1, W_LO), (XN1, Y_LO), (XFAN + MEANDER, Y_LO),
            (XU3_IN, 25.950), (XU3_OUT, 25.950),
            (109.126, 25.750), (110.825, 25.750),            # into J2.B7
            (109.126, 25.750), (110.126, 24.750), (110.825, 24.750)]  # branch to J2.A7
